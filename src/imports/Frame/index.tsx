...
import svgPaths from "./svg-xkjrrw3oav";
...
function Body() {
  return (
    <div className="absolute bg-[#faf7f3] content-stretch flex flex-col h-[7048px] items-start left-[0.17px] pb-[140px] right-[-0.17px] top-[-0.14px]" data-name="body">
      <EndOfBodyStart />
