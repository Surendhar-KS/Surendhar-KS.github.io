...
import imgYceQcLz3ChOtgu2OZRjmfEKjYPng from "./cbf71e4022f3ddc84eb60bb6a194639bf7c42a36.png";
import imgManStandingNearWhiteWall from "./d839c58fb36faf58b26b11dac0c27e05792a6d9c.png";
import imgGN85DqTeMmVvE57UMiHhgeL4P4Png from "./956392cf6be7486afad9c12dec252937e601f8e2.png";
import imgManInBlackButtonUpShirt from "./355e18cf9140ad4ecf78fd60f88b124293361c01.png";
import imgWsYtug4CqmLiu4LwbMuqx7FdOyPng from "./b8bc820742a1f270d5676f3ea5fdd5d981b90474.png";
import imgLxtBXj3G7Bloek83WxPy1ZUuw0QPng from "./bd176e96850d1a0b20af0bcedb44db2993048081.png";
import imgIc9K42RYytbJtnRujXdcNxChScPng from "./7dbac7bf55bf3787aaddbca3d2e751df601529b7.png";
...
function Component1({ className, variant = "1" }: Component1Props) {
  const is2Or3Or4Or5 = ["2", "3", "4", "5"].includes(variant);
  const is3 = variant === "3";
  const is4 = variant === "4";
  const is5 = variant === "5";
  ...
  const is8 = variant === "8";
  return (
    <div className={className || `overflow-clip relative ${is7Or8 ? "size-[16px]" : variant === "6" ? "h-[375px] w-[1200px]" : is2Or3Or4Or5 ? "size-[20px]" : "size-[64px]"}`}>
      {["1", "2", "3", "4", "5"].includes(variant) && (
        <svg className="absolute block inset-0 size-full" fill="none" height={is2Or3Or4Or5 ? "20" : "64"} preserveAspectRatio="none" viewBox={is2Or3Or4Or5 ? "0 0 20 20" : "0 0 64 64"} width={is2Or3Or4Or5 ? "20" : "64"}>
          {is2Or3Or4Or5 && (
            <g clipPath={is4 ? "url(#clip0_0_38)" : is3 ? "url(#clip0_0_36)" : undefined} id={is5 ? "832930135" : is4 ? "3343558269" : is3 ? "2660449837" : "1554250168"}>
              <path d={is5 ? svgPaths.p193f5480 : is4 ? svgPaths.pc8bab00 : is3 ? svgPaths.pdedca80 : svgPaths.p9d0b1f0} id={is5 ? "gjBIq5II1" : is4 ? "zjjX2FG5P" : is3 ? "SX1RGYN3B" : "I7SuWiIoi"} stroke="#111111" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
              {["4", "5"].includes(variant) && <path d={is5 ? svgPaths.p205b7af0 : svgPaths.p3575d1f0} id={is5 ? "H7TM4gAQc" : "c0NPcsxWN"} stroke="#111111" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />}
              {is4 && <path d={svgPaths.pd7c4380} id="rJBOynbA9" stroke="#111111" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />}
            </g>
          )}
          {["3", "4"].includes(variant) && (
            <defs>
              <clipPath id={is4 ? "clip0_0_38" : "clip0_0_36"}>
  ...
  return (
    <div className={className || "overflow-clip relative size-[28.284px]"}>
      <svg className="absolute block inset-0 size-full" fill="none" height="20" preserveAspectRatio="none" viewBox="0 0 20 20" width="20">
        <g id="1235104226">
          <path d={svgPaths.p370e6b00} id="JgTGlz8TK" stroke={["2", "4", "5"].includes(variant) ? "#FAF7F3" : "#111111"} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function AvatarBack() {
  return (
    <div className="absolute flex h-[228px] items-center justify-center left-[100px] top-[228px] w-[200px]">
      <div className="-scale-y-100 flex-none rotate-180">
        <div className="content-stretch flex flex-col h-[228px] items-start justify-center overflow-clip relative rounded-[20px] w-[200px]" data-name="Avatar - Back">
...
function AvatarFront() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[228px] items-start justify-center left-[100px] overflow-clip rounded-[20px] top-[228px] w-[200px]" data-name="Avatar - Front">
...
function AvatarWrap() {
  return (
    <motion.div initial={{ opacity: 0, y: 20, scale: 0.96 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: 0.8, delay: 0.8, ease: [0.16, 1, 0.3, 1] }} className="h-[456px] relative shrink-0 w-[400px]" data-name="Avatar Wrap">
      <AvatarBack />
      <AvatarFront />
    </motion.div>
  );
...
function StickyContainer() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-[900px] items-end justify-center min-w-px overflow-clip pb-[20px] sticky top-0" data-name="Sticky Container">
      <AvatarWrap />
    </div>
  );
}
...
function StickyAvatarWrap() {
  return (
    <div className="content-stretch flex h-[1800px] items-start justify-center relative shrink-0 w-full" data-name="Sticky Avatar Wrap">
      <StickyContainer />
    </div>
  );
}
...
function Span() {
  return (
    <div className="blur-[0px] h-[156.6px] relative shrink-0 w-[1008.34px]" data-name="span">
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Archivo:ExtraBold',sans-serif] font-extrabold justify-center leading-[0] left-[calc(50%+1.93px)] text-[color:var(--reveal-color,#111)] text-[174px] text-center top-[77.6px] tracking-[-3.48px] w-[1012.193px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[156.6px]">SOFTWARE</p>
      </div>
    </div>
  );
}
...
function Span1() {
  return (
    <div className="blur-[0px] h-[156.6px] relative shrink-0 w-[940.48px]" data-name="span">
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Archivo:ExtraBold',sans-serif] font-extrabold justify-center leading-[0] left-[calc(50%+2.35px)] text-[color:var(--reveal-color,#111)] text-[174px] text-center top-[77.6px] tracking-[-3.48px] w-[945.179px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[156.6px]">ENGINEER</p>
      </div>
      <HoloTriangleRounded />
    </div>
  );
...
function LIIjRx5GxRdY7UWw5WqIXicPoaPng() {
  return (
    <div className="h-[159.998px] relative shrink-0 w-full" data-name="lIIjRX5gxRdY7UWw5wqIXicPOA.png">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgLIIjRx5GxRdY7UWw5WqIXicPoaPng} />
      </div>
    </div>
  );
}
...
function HoloTriangleRounded() {
    return (
      <div className="absolute bottom-[-98.95px] flex h-[197.902px] items-center justify-center right-[-34.95px] w-[197.903px] z-[50]">
      <div className="flex-none rotate-16">
        <div className="aspect-[160/160] content-stretch flex flex-col items-start justify-center relative w-full" data-name="holo_triangle_rounded">
...
function OldYsHb9RMavvQrkVrNy08ZxyePng() {
  return (
    <div className="h-[140px] relative shrink-0 w-full" data-name="OLDYsHB9RMavvQrkVRNy08ZXYE.png">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
function HoloTriangleRounded1() {
  return (
    <div className="absolute content-stretch flex flex-col items-start justify-center left-[-16px] top-[-60px] w-[140px]" data-name="holo_triangle_rounded">
...
function H2FramerText() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h2.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[color:var(--reveal-color,#111)] text-[68px] tracking-[-1.36px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[68px]">©2026</p>
      </div>
    </div>
  );
}

function DivFramerLdffyv() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="div.framer-ldffyv">
      <H2FramerText />
    </div>
  );
}
  ...
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 right-0 top-[-1px]" data-name="p.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[color:var(--reveal-color,#111)] text-[18px] tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px]">SURENDHAR K</p>
      </div>
    </div>
  );
}
...
function DivFramerJb5Itc() {
  return (
    <div className="h-[25.2px] relative shrink-0 w-[187.3px]" data-name="div.framer-jb5itc">
      <PFramerText />
    </div>
  );
}
...
function Text() {
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 1.0, ease: [0.16, 1, 0.3, 1] }} className="absolute bottom-[20px] content-stretch flex items-end justify-between left-0 right-0" data-name="Text">
      <DivFramerLdffyv />
      <DivFramerJb5Itc />
    </motion.div>
  );
...
function Container() {
  return (
    <div className="content-stretch flex h-full items-center max-w-[1180px] relative shrink-0 w-[1180px]" data-name="Container">
      <Title />
      <Text />
    </div>
  );
...
function HeroSection() {
  return (
    <div className="content-stretch flex h-[900px] items-center justify-center relative shrink-0 w-full" data-name="Hero Section">
      <Container />
    </div>
  );
}
...
function Span2() {
  return (
    <div className="blur-[0px] content-stretch flex items-start relative shrink-0" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[color:var(--reveal-color,#111)] text-[76px] tracking-[-1.52px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[76px]">Hey!</p>
      </div>
    </div>
  );
}
...
function TitleDescription() {
  return (
    <div className="content-stretch flex flex-col gap-[259.4px] h-full items-center max-w-[300px] relative shrink-0 w-[300px]" data-name="Title & Description">
      <H2FramerText1 />
      <PFramerText1 />
    </div>
  );
...
function TitleDescriptionAlignStretch() {
  return (
    <div className="content-stretch flex h-full items-start justify-center relative shrink-0" data-name="Title & Description:align-stretch">
      <TitleDescription />
    </div>
  );
}
...
function ArrowButton() {
  return (
    <div className="overflow-clip relative rounded-[8px] shrink-0 size-[28px]" data-name="Arrow Button">
      ...
      <Component className="absolute bottom-[-21.14px] flex items-center justify-center left-[-21.14px] size-[28.284px]" variant="2" />
    </div>
  );
}
...
function Paragraphs() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] h-full items-start justify-end max-w-[360px] relative shrink-0 w-[360px]" data-name="Paragraphs">
      <DivFramer159Qlij />
...
function ParagraphsAlignStretch() {
  return (
    <div className="content-stretch flex h-full items-start justify-center relative shrink-0" data-name="Paragraphs:align-stretch">
      <Paragraphs />
    </div>
  );
}
...
function Container1() {
  return (
    <ScrollReveal className="content-stretch flex h-[479.2px] items-end justify-between max-w-[1180px] pb-[20px] relative shrink-0 w-[1180px]" data-name="Container">
      <TitleDescriptionAlignStretch />
      <ParagraphsAlignStretch />
    </ScrollReveal>
  );
}
...
function BioSection() {
  return (
    <div className="content-stretch flex h-[900px] items-end justify-center relative shrink-0 w-full" data-name="Bio Section">
      <Container1 />
    </div>
  );
}
...
function Content() {
  return (
    <div className="absolute content-stretch flex flex-col items-center justify-center left-0 overflow-clip right-0 top-0" data-name="Content">
      <HeroSection />
      <BioSection />
    </div>
  );
...
function HeroBioSections() {
  return (
    <div className="content-stretch flex flex-col h-[1800px] items-center justify-center relative shrink-0 w-full" data-name="Hero & Bio Sections">
      <StickyAvatarWrap />
      <Content />
    </div>
  );
...
function WordSpan({ text }: { text: string }) {
  return (
    <div className="flex items-start justify-center" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[color:var(--reveal-color,#111)] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">{text}</p>
      </div>
    </div>
  );
}
...
function Div() {
  ...
  return (
    <div className="flex flex-wrap items-center justify-center gap-x-[12px] gap-y-0 relative shrink-0 w-full" data-name="div">
...
function DivFramer7Opu6LContainer() {
  return (
    <div className="content-stretch flex flex-col items-start max-w-[840px] relative shrink-0 w-[840px]" data-name="div.framer-7opu6l-container">
      <Div />
    </div>
  );
}
...
function Content1() {
  return (
    <div className="content-stretch flex h-[900px] items-center justify-center overflow-clip shrink-0 sticky top-0 w-full" data-name="Content">
...
function Container2() {
  return (
    <div className="content-stretch flex flex-col h-[1350px] items-center max-w-[1180px] relative shrink-0 w-[1180px]" data-name="Container">
      <Content1 />
    </div>
  );
}
...
function QuoteSection() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-full" data-name="Quote Section">
      <Container2 />
    </div>
  );
}
...
function Span30() {
  return (
    <div className="blur-[0px] content-stretch flex items-start relative shrink-0" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[color:var(--reveal-color,#111)] text-[76px] tracking-[-1.52px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[76px]">Services</p>
      </div>
    </div>
  );
}
...
function H3FramerText() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h3.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[color:var(--reveal-color,#111)] text-[32px] tracking-[-0.64px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[38.4px]">Website Migration</p>
      </div>
    </div>
  );
}

function DivFramer1S0Oqn() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="div.framer-1s0oqn3">
      <H3FramerText />
    </div>
  );
}
...
function DivFramerX4K8Oa() {
  return (
    <div className="h-[25.2px] relative shrink-0 w-[105px]" data-name="div.framer-x4k8oa">
      <PFramerText5 />
    </div>
  );
}
...
function DivFramer1Dvkwdb() {
  return (
    <div className="h-[25.2px] relative shrink-0 w-[92.89px]" data-name="div.framer-1dvkwdb">
      <PFramerText6 />
    </div>
  );
}
...
function DivFramer1Eaeiv() {
  return (
    <div className="h-[25.2px] relative shrink-0 w-[112.66px]" data-name="div.framer-1eaeiv5">
      <PFramerText7 />
    </div>
  );
}
...
function Categories() {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center relative shrink-0" data-name="Categories">
      <DivFramerX4K8Oa />
...
function Desktop() {
  return (
    <div className="bg-[#faf7f3] content-stretch flex items-center justify-between min-h-[120px] overflow-clip py-[40.8px] relative shrink-0 w-full" data-name="Desktop">
      <DivFramer1S0Oqn />
...
function DivFramer99NfdqContainer() {
  return (
    <div className="content-stretch flex flex-col items-start min-w-[1180px] relative shrink-0" data-name="div.framer-99nfdq-container">
      <Desktop />
    </div>
  );
}
...
function H3FramerText1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h3.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[color:var(--reveal-color,#111)] text-[32px] tracking-[-0.64px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[38.4px]">Framer Templates</p>
      </div>
    </div>
  );
}

function DivFramer1S0Oqn1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="div.framer-1s0oqn3">
      <H3FramerText1 />
    </div>
...
function DivFramer5X1N75Container() {
  return (
    <div className="content-stretch flex flex-col items-start min-w-[1180px] relative shrink-0" data-name="div.framer-5x1n75-container">
      <Desktop1 />
    </div>
  );
}
...
function H3FramerText2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h3.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[color:var(--reveal-color,#111)] text-[32px] tracking-[-0.64px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[38.4px]">Frontend Development</p>
      </div>
    </div>
  );
}

function DivFramer1S0Oqn2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="div.framer-1s0oqn3">
      <H3FramerText2 />
    </div>
...
function DivFramerX4K8Oa2() {
  return (
    <div className="h-[25.2px] relative shrink-0 w-[49.56px]" data-name="div.framer-x4k8oa">
      <PFramerText11 />
    </div>
  );
}
...
function DivFramer1Dvkwdb2() {
  return (
    <div className="h-[25.2px] relative shrink-0 w-[148.78px]" data-name="div.framer-1dvkwdb">
      <PFramerText12 />
    </div>
  );
}
...
function DivFramer1Eaeiv2() {
  return (
    <div className="h-[25.2px] relative shrink-0 w-[132.3px]" data-name="div.framer-1eaeiv5">
      <PFramerText13 />
    </div>
  );
}
...
function DivFramer945PruContainer() {
  return (
    <div className="content-stretch flex flex-col items-start min-w-[1180px] relative shrink-0" data-name="div.framer-945pru-container">
      <Desktop2 />
    </div>
  );
}
...
function H3FramerText3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h3.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[color:var(--reveal-color,#111)] text-[32px] tracking-[-0.64px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[38.4px]">Product Consulting</p>
      </div>
    </div>
  );
}

function DivFramer1S0Oqn3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="div.framer-1s0oqn3">
      <H3FramerText3 />
    </div>
...
function DivFramerX4K8Oa3() {
  return (
    <div className="h-[25.2px] relative shrink-0 w-[126.61px]" data-name="div.framer-x4k8oa">
      <PFramerText14 />
    </div>
  );
}
...
function DivFramer1Dvkwdb3() {
  return (
    <div className="h-[25.2px] relative shrink-0 w-[98.38px]" data-name="div.framer-1dvkwdb">
      <PFramerText15 />
    </div>
  );
}
...
function DivFramer1Eaeiv3() {
  return (
    <div className="h-[25.2px] relative shrink-0 w-[144.85px]" data-name="div.framer-1eaeiv5">
      <PFramerText16 />
    </div>
  );
}
...
function DivFramerMg5C04Container() {
  return (
    <div className="content-stretch flex flex-col items-start min-w-[1180px] relative shrink-0" data-name="div.framer-mg5c04-container">
      <Desktop3 />
    </div>
  );
}
...
function Container3() {
  return (
    <ScrollReveal className="content-stretch flex flex-col gap-[60px] items-start justify-center max-w-[1180px] relative shrink-0 w-[1180px]" data-name="Container">
      <DivFramer1Nuet6A />
      <ServicesCards />
    </ScrollReveal>
  );
...
function ServicesSection() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Services Section">
      <Container3 />
    </div>
  );
}
...
function Span31() {
  return (
    <div className="blur-[0px] content-stretch flex items-start mb-[-0.4px] relative shrink-0" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[color:var(--reveal-color,#111)] text-[76px] tracking-[-1.52px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[76px]">Curated</p>
      </div>
    </div>
  );
}
...
function Span32() {
  return (
    <div className="blur-[0px] content-stretch flex items-start relative shrink-0" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[color:var(--reveal-color,#111)] text-[76px] tracking-[-1.52px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[76px]">Projects</p>
      </div>
    </div>
  );
}
...
function DivFramer16Hn49O() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start max-w-[460px] min-w-px relative" data-name="div.framer-16hn49o">
      <H2FramerText3 />
    </div>
  );
}
...
function ArrowButton1() {
  return (
    <div className="overflow-clip relative rounded-[8px] shrink-0 size-[28px]" data-name="Arrow Button">
      <div className="absolute border border-[#111] border-solid inset-0 rounded-[8px]" data-name="::after" />
      <Component className="-translate-x-1/2 absolute bottom-[-0.51%] flex items-center justify-center left-1/2 top-[-0.51%] w-[28.284px]" variant="3" />
      <Component className="absolute bottom-[-21.14px] flex items-center justify-center left-[-21.14px] size-[28.284px]" variant="4" />
    </div>
  );
}
...
function ButtonWrap() {
  return (
    <div className="content-stretch flex items-center justify-center overflow-clip relative shrink-0" data-name="Button Wrap">
...
function TitleButton() {
  return (
    <div className="content-stretch flex items-end justify-between relative shrink-0 w-full" data-name="Title & Button">
      <DivFramer16Hn49O />
      <ButtonWrap />
    </div>
  );
...
function Image() {
  return (
    <div className="content-stretch flex flex-col h-[401.38px] items-start justify-center relative rounded-[20px] shrink-0 w-[582px]" data-name="Image">
...
function H3FramerText4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h3.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-white text-[32px] tracking-[-0.64px] w-full drop-shadow-[0_2px_10px_rgba(0,0,0,0.55)]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[38.4px]">AI-Powered Interview Platform</p>
      </div>
    </div>
  );
}
...
function DivFramerV4Eg3F() {
  return (
    <div className="content-stretch flex flex-col items-start mb-[-0.01px] relative shrink-0 w-full" data-name="div.framer-v4eg3f">
      <H3FramerText4 />
    </div>
  );
}
...
function DivFramer1Eobfit() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="div.framer-1eobfit">
      <PFramerText18 />
    </div>
  );
}
...
function TitleDescription1() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center overflow-clip relative shrink-0 w-full" data-name="Title & Description">
      <DivFramerV4Eg3F />
      <DivFramer1Eobfit />
    </div>
  );
...
function DivFramer19XgbboContainer() {
  return (
    <div className="absolute content-stretch flex flex-col inset-[0_598px_486.98px_0] items-start" data-name="div.framer-19xgbbo-container">
      <ProjectCard />
    </div>
  );
}
...
function H3FramerText5() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h3.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-white text-[32px] tracking-[-0.64px] w-full drop-shadow-[0_2px_10px_rgba(0,0,0,0.55)]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[38.4px]">Portable Microplastic Detection</p>
      </div>
    </div>
  );
}
...
function DivFramer19XgbboContainer1() {
  return (
    <div className="absolute content-stretch flex flex-col inset-[0_0_486.98px_598px] items-start" data-name="div.framer-19xgbbo-container">
      <ProjectCard1 />
    </div>
  );
}
...
function H3FramerText6() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h3.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-white text-[32px] tracking-[-0.64px] w-full drop-shadow-[0_2px_10px_rgba(0,0,0,0.55)]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[38.4px]">Retail Analytics Dashboard</p>
      </div>
    </div>
  );
}
...
function DivFramerV4Eg3F2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="div.framer-v4eg3f">
      <H3FramerText6 />
    </div>
  );
}
...
function ProjectCard2() {
  return (
    <div className="content-stretch flex flex-col gap-[9.99px] items-start justify-center overflow-clip relative shrink-0 w-full" data-name="Project Card">
      <ImageWrap2 />
      <TitleDescription3 />
    </div>
  );
...
function DivFramer19XgbboContainer2() {
  return (
    <div className="absolute content-stretch flex flex-col inset-[488.18px_598px_-1.2px_0] items-start" data-name="div.framer-19xgbbo-container">
      <ProjectCard2 />
    </div>
  );
}
...
function H3FramerText7() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h3.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-white text-[32px] tracking-[-0.64px] w-full drop-shadow-[0_2px_10px_rgba(0,0,0,0.55)]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[38.4px]">SmartBus Live Tracker</p>
      </div>
    </div>
  );
}
...
function DivFramer19XgbboContainer3() {
  return (
    <div className="absolute content-stretch flex flex-col inset-[488.18px_0_-1.2px_598px] items-start" data-name="div.framer-19xgbbo-container">
      <ProjectCard3 />
    </div>
  );
}
...
function DivFramer6Rbvdk() {
  return (
    <div className="h-[960.35px] relative shrink-0 w-full" data-name="div.framer-6rbvdk">
...
function ProjectsSection() {
  return (
    <div className="content-stretch flex items-center justify-center pt-[180px] relative shrink-0 w-full" data-name="Curated Projects Section">
      <Container4 />
    </div>
  );
}
...
function Span33() {
  return (
    <div className="blur-[0px] content-stretch flex items-start relative shrink-0" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[color:var(--reveal-color,#111)] text-[76px] tracking-[-1.52px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[76px]">Testimonials</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="p.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[18px] tracking-[-0.72px] w-full whitespace-pre-wrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px] mb-0">{`Templyo completely changed `}</p>
        <p className="leading-[25.2px] mb-0">{`how I approach building sites in `}</p>
        <p className="leading-[25.2px] mb-0">{`Framer. The templates are not `}</p>
        <p className="leading-[25.2px] mb-0">{`just beautiful, they’re actually `}</p>
        <p className="leading-[25.2px] mb-0">{`structured in a way that makes `}</p>
...
function FrontFace1() {
  return (
    <div className="absolute bg-[#111] content-stretch flex flex-col inset-[0_0.17%_0_-0.17%] items-center justify-between pb-[20px] pt-[19px] px-[20px] rounded-[20px]" data-name="Front Face">
      <PFramerText22 />
      <Author />
    </div>
  );
...
function DivFramerE41VzkContainer() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative self-stretch" data-name="div.framer-e41vzk-container">
      <FrontFace />
    </div>
  );
}
...
function PFramerText25() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[0.6px] relative shrink-0 w-full" data-name="p.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[18px] tracking-[-0.72px] w-full whitespace-pre-wrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px] mb-0">{`I’ve tried dozens of Framer `}</p>
        <p className="leading-[25.2px] mb-0">{`templates, but Templyo stands `}</p>
        <p className="leading-[25.2px] mb-0">{`out. Everything feels intentional, `}</p>
        <p className="leading-[25.2px] mb-0">{`from the layout to the smallest `}</p>
...
function DivFramer1WumwmxContainer() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative self-stretch" data-name="div.framer-1wumwmx-container">
      <FrontFace2 />
    </div>
  );
}
...
function PFramerText28() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="p.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[18px] tracking-[-0.72px] w-full whitespace-pre-wrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px] mb-0">{`Templyo saved me weeks of `}</p>
        <p className="leading-[25.2px] mb-0">{`work. I was able to launch my `}</p>
        <p className="leading-[25.2px] mb-0">{`landing page in a day, and it still `}</p>
        <p className="leading-[25.2px]">looks fully custom.</p>
      </div>
    </div>
  );
}
...
function DivFramer1TcmudkContainer() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative self-stretch" data-name="div.framer-1tcmudk-container">
      <FrontFace4 />
    </div>
  );
}
...
function PFramerText31() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[0.6px] relative shrink-0 w-full" data-name="p.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[18px] tracking-[-0.72px] w-full whitespace-pre-wrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px] mb-0">{`The quality is insane. Clean `}</p>
        <p className="leading-[25.2px] mb-0">{`structure, smooth animations, `}</p>
        <p className="leading-[25.2px] mb-0">{`and super easy to customize. It `}</p>
        <p className="leading-[25.2px] mb-0">{`feels like a premium product from `}</p>
        <p className="leading-[25.2px]">start to finish.</p>
      </div>
    </div>
  );
}
...
function DivFramerLyzmtsContainer() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative self-stretch" data-name="div.framer-lyzmts-container">
      <FrontFace6 />
    </div>
  );
}
...
function TestimonialsCards() {
  return (
    <div className="content-stretch flex gap-[16px] items-start justify-center relative shrink-0 w-full" data-name="Testimonials Cards">
...
function TestimonialsSection() {
  return (
    <div className="content-stretch flex items-center justify-center pt-[120px] relative shrink-0 w-full" data-name="Testimonials Section">
      <Container5 />
    </div>
  );
}
...
function Span34() {
  return (
    <div className="blur-[0px] content-stretch flex items-start relative shrink-0" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[color:var(--reveal-color,#111)] text-[76px] tracking-[-1.52px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[76px]">Thoughts</p>
      </div>
    </div>
  );
}
...
function LxtBXj3G7Bloek83WxPy1ZUuw0QPng() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="lxtBXj3G7Bloek83WxPY1ZUuw0Q.png">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-full left-[-56.85%] max-w-none top-0 w-[213.71%]" src={imgLxtBXj3G7Bloek83WxPy1ZUuw0QPng} />
      </div>
    </div>
  );
}
...
function H3FramerText8() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h3.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[32px] tracking-[-0.64px] w-full" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[38.4px] mb-0">Building Trust</p>
        <p className="leading-[38.4px]">Through Clear Design</p>
      </div>
    </div>
  );
}
...
function TitleDate() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] items-start justify-center relative shrink-0 w-full" data-name="Title & Date">
      <DivFramer4Voal />
      <DivFramerNa2Wwt />
    </div>
  );
...
function DivFramer1GwykhoContainer() {
  return (
    <div className="content-stretch flex flex-col items-start relative self-stretch shrink-0 w-[382.66px]" data-name="div.framer-1gwykho-container">
      <Primary2 />
    </div>
  );
}
...
function Ic9K42RYytbJtnRujXdcNxChScPng() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="ic9k42rYytbJtnRUJXdcNxCHSc.png">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-full left-[-57.23%] max-w-none top-0 w-[214.45%]" src={imgIc9K42RYytbJtnRujXdcNxChScPng} />
      </div>
    </div>
  );
}
...
function H3FramerText9() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h3.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[32px] tracking-[-0.64px] w-full" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[38.4px] mb-0">The Role of Art</p>
        <p className="leading-[38.4px]">Direction in Branding</p>
      </div>
    </div>
  );
}
...
function PFramerText37() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="p.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[16px] tracking-[-0.64px] w-full whitespace-pre-wrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[22.4px] mb-0">{`Why visual direction helps brands create emotion and `}</p>
        <p className="leading-[22.4px]">a distinct point of view.</p>
      </div>
    </div>
  );
}
...
function Span35() {
  return (
    <div className="absolute blur-[0px] content-stretch flex items-start left-0 top-[-0.1px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[44px] tracking-[-0.88px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[52.8px]">See</p>
      </div>
    </div>
  );
}
...
function Span36() {
  return (
    <div className="absolute blur-[0px] content-stretch flex items-start left-[83.52px] top-[-0.1px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[44px] tracking-[-0.88px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[52.8px]">how</p>
      </div>
    </div>
  );
}
...
function Span37() {
  return (
    <div className="absolute blur-[0px] content-stretch flex items-start left-[170.66px] top-[-0.1px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[44px] tracking-[-0.88px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[52.8px]">we</p>
      </div>
    </div>
  );
}
...
function Span38() {
  return (
    <div className="absolute blur-[0px] content-stretch flex items-start left-0 top-[52.7px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[44px] tracking-[-0.88px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[52.8px]">shape</p>
      </div>
    </div>
  );
}
...
function Span39() {
  return (
    <div className="absolute blur-[0px] content-stretch flex items-start left-[124.18px] top-[52.7px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[44px] tracking-[-0.88px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[52.8px]">brands</p>
      </div>
    </div>
  );
}
...
function Span40() {
  return (
    <div className="absolute blur-[0px] content-stretch flex items-start left-0 top-[105.5px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[44px] tracking-[-0.88px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[52.8px]">with</p>
      </div>
    </div>
  );
}
...
function Span41() {
  return (
    <div className="absolute blur-[0px] content-stretch flex items-start left-[84.36px] top-[105.5px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[44px] tracking-[-0.88px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[52.8px]">clarity</p>
      </div>
    </div>
  );
}
...
function Span42() {
  return (
    <div className="absolute blur-[0px] content-stretch flex items-start left-[203px] top-[105.5px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[44px] tracking-[-0.88px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[52.8px]">and</p>
      </div>
    </div>
  );
}
...
function Span43() {
  return (
    <div className="absolute blur-[0px] content-stretch flex items-start left-0 top-[158.3px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[44px] tracking-[-0.88px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[52.8px]">craft—</p>
      </div>
    </div>
  );
}
...
function Span44() {
  return (
    <div className="absolute blur-[0px] content-stretch flex items-start left-[133.42px] top-[158.3px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[44px] tracking-[-0.88px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[52.8px]">explore</p>
      </div>
    </div>
  );
}
...
function Span45() {
  return (
    <div className="absolute blur-[0px] content-stretch flex items-start left-0 top-[211.1px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[44px] tracking-[-0.88px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[52.8px]">our</p>
      </div>
    </div>
  );
}
...
function Span46() {
  return (
    <div className="absolute blur-[0px] content-stretch flex items-start left-[70.11px] top-[211.1px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[44px] tracking-[-0.88px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[52.8px]">blog</p>
      </div>
    </div>
  );
}
...
function PFramerText38() {
  return (
    <div className="h-[264px] relative shrink-0 w-full" data-name="p.framer-text">
      <Span35 />
      <Span36 />
      <Span37 />
      <Span38 />
...
function ArrowButton2() {
  return (
    <div className="overflow-clip relative rounded-[8px] shrink-0 size-[28px]" data-name="Arrow Button">
      ...
      <Component className="-translate-x-1/2 absolute bottom-[-0.51%] flex items-center justify-center left-[calc(50%-0.01px)] top-[-0.51%] w-[28.284px]" variant="5" />
      <Component className="absolute bottom-[-21.14px] flex items-center justify-center left-[-21.15px] size-[28.284px]" variant="6" />
    </div>
  );
}
...
function AllPostsCard() {
  return (
    <div className="bg-[#111] min-h-[460px] relative rounded-[16px] self-stretch shrink-0 w-[382.68px]" data-name="All Posts Card">
...
function Span47() {
  return (
    <div className="blur-[0px] content-stretch flex items-start relative shrink-0" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[color:var(--reveal-color,#111)] text-[76px] tracking-[-1.52px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[76px]">Let’s</p>
      </div>
    </div>
  );
}
...
function Span48() {
  return (
    <div className="blur-[0px] content-stretch flex items-start relative shrink-0" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[color:var(--reveal-color,#111)] text-[76px] tracking-[-1.52px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[76px]">talk.</p>
      </div>
    </div>
  );
}
...
function H2FramerText6() {
  return (
    <div className="content-stretch flex gap-[13.69px] items-start relative shrink-0 w-full" data-name="h2.framer-text">
      <Span47 />
      <Span48 />
    </div>
  );
...
function Span49() {
  return (
    <div className="blur-[0px] h-[25.2px] relative shrink-0 w-[39.03px]" data-name="span">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] left-0 text-[color:var(--reveal-color,#111)] text-[18px] top-[12px] tracking-[-0.72px] w-[40.107px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px]">Have</p>
      </div>
    </div>
  );
}
...
function Span50() {
  return (
    <div className="blur-[0px] h-[25.2px] relative shrink-0 w-[9.1px]" data-name="span">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] left-0 text-[color:var(--reveal-color,#111)] text-[18px] top-[12px] tracking-[-0.72px] w-[10.115px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px]">a</p>
      </div>
    </div>
  );
}
...
function Span51() {
  return (
    <div className="blur-[0px] h-[25.2px] relative shrink-0 w-[49.8px]" data-name="span">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] left-0 text-[color:var(--reveal-color,#111)] text-[18px] top-[12px] tracking-[-0.72px] w-[51.137px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px]">project</p>
      </div>
    </div>
  );
}
...
function Span52() {
  return (
    <div className="blur-[0px] h-[25.2px] relative shrink-0 w-[14.8px]" data-name="span">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] left-0 text-[color:var(--reveal-color,#111)] text-[18px] top-[12px] tracking-[-0.72px] w-[16.11px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px]">or</p>
      </div>
    </div>
  );
}
...
function Span53() {
  return (
    <div className="blur-[0px] h-[25.2px] relative shrink-0 w-[37.2px]" data-name="span">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] left-0 text-[color:var(--reveal-color,#111)] text-[18px] top-[12px] tracking-[-0.72px] w-[38.104px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px]">need</p>
      </div>
    </div>
  );
}
...
function Span54() {
  return (
    <div className="blur-[0px] h-[25.2px] relative shrink-0 w-[41.06px]" data-name="span">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] left-0 text-[color:var(--reveal-color,#111)] text-[18px] top-[12px] tracking-[-0.72px] w-[42.114px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px]">help?</p>
      </div>
    </div>
  );
}
...
function Span55() {
  return (
    <div className="blur-[0px] h-[25.2px] relative shrink-0 w-[20.29px]" data-name="span">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] left-0 text-[color:var(--reveal-color,#111)] text-[18px] top-[12px] tracking-[-0.72px] w-[21.105px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px]">Fill</p>
      </div>
    </div>
  );
}
...
function Span56() {
  return (
    <div className="blur-[0px] h-[25.2px] relative shrink-0 w-[23.56px]" data-name="span">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] left-0 text-[color:var(--reveal-color,#111)] text-[18px] top-[12px] tracking-[-0.72px] w-[25.102px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px]">out</p>
      </div>
    </div>
  );
}
...
function Span57() {
  return (
    <div className="blur-[0px] h-[25.2px] relative shrink-0 w-[23.19px]" data-name="span">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] left-0 text-[color:var(--reveal-color,#111)] text-[18px] top-[12px] tracking-[-0.72px] w-[24.12px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px]">the</p>
      </div>
    </div>
  );
}
...
function Span58() {
  return (
    <div className="blur-[0px] h-[25.2px] relative shrink-0 w-[38.06px]" data-name="span">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] left-0 text-[color:var(--reveal-color,#111)] text-[18px] top-[12px] tracking-[-0.72px] w-[39.104px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px]">form,</p>
      </div>
    </div>
  );
}
...
function Span59() {
  return (
    <div className="blur-[0px] h-[25.2px] relative shrink-0 w-[28px]" data-name="span">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] left-0 text-[color:var(--reveal-color,#111)] text-[18px] top-[12px] tracking-[-0.72px] w-[29.144px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px]">and</p>
      </div>
    </div>
  );
}
...
function Span60() {
  return (
    <div className="blur-[0px] h-[25.2px] relative shrink-0 w-[30.96px]" data-name="span">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] left-0 text-[color:var(--reveal-color,#111)] text-[18px] top-[12px] tracking-[-0.72px] w-[32.161px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px]">{`we'll`}</p>
      </div>
    </div>
  );
}
...
function Span61() {
  return (
    <div className="blur-[0px] h-[25.2px] relative shrink-0 w-[23.06px]" data-name="span">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] left-0 text-[color:var(--reveal-color,#111)] text-[18px] top-[12px] tracking-[-0.72px] w-[24.115px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px]">get</p>
      </div>
    </div>
  );
}
...
function Span62() {
  return (
    <div className="blur-[0px] h-[25.2px] relative shrink-0 w-[35.74px]" data-name="span">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] left-0 text-[color:var(--reveal-color,#111)] text-[18px] top-[12px] tracking-[-0.72px] w-[37.184px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px]">back</p>
      </div>
    </div>
  );
}
...
function Span63() {
  return (
    <div className="blur-[0.003px] h-[25.2px] opacity-100 relative shrink-0 w-[14.18px]" data-name="span">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] left-0 text-[color:var(--reveal-color,#111)] text-[18px] top-[12px] tracking-[-0.72px] w-[15.126px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px]">to</p>
      </div>
    </div>
  );
}
...
function Span64() {
  return (
    <div className="blur-[0.004px] h-[25.2px] opacity-100 relative shrink-0 w-[27.2px]" data-name="span">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] left-0 text-[color:var(--reveal-color,#111)] text-[18px] top-[12.01px] tracking-[-0.72px] w-[28.145px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px]">you</p>
      </div>
    </div>
  );
}
...
function Span65() {
  return (
    <div className="blur-[0.006px] h-[25.2px] opacity-100 relative shrink-0 w-[41.23px]" data-name="span">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] left-0 text-[color:var(--reveal-color,#111)] text-[18px] top-[12px] tracking-[-0.72px] w-[42.117px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px]">soon.</p>
      </div>
    </div>
  );
}
...
function PFramerText40() {
  return (
    <div className="content-stretch flex gap-[3px] items-start relative shrink-0 w-full" data-name="p.framer-text">
      <Span49 />
      <Span50 />
      <Span51 />
      <Span52 />
...
function TitleDescription5() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center justify-center relative shrink-0 w-full" data-name="Title & Description">
      <DivFramer15Yiv3X />
      <DivFramerJf7A8U />
    </div>
  );
...
function Primary4() {
  return (
    <div className="bg-[rgba(0,0,0,0.1)] content-stretch flex items-center justify-center overflow-clip relative rounded-[8px] shrink-0 size-[40px]" data-name="Primary">
      <Component1 className="overflow-clip relative shrink-0 size-[20px]" variant="2" />
    </div>
  );
}
...
function Primary5() {
  return (
    <div className="bg-[rgba(0,0,0,0.1)] content-stretch flex items-center justify-center overflow-clip relative rounded-[8px] shrink-0 size-[40px]" data-name="Primary">
      <Component1 className="overflow-clip relative shrink-0 size-[20px]" variant="3" />
    </div>
  );
}
...
function DivFramerJjv3ItContainer() {
  return (
    <div className="content-stretch flex flex-col items-start opacity-100 relative shrink-0" data-name="div.framer-jjv3it-container">
      <Primary5 />
    </div>
  );
}
...
function Primary6() {
  return (
    <div className="bg-[rgba(0,0,0,0.1)] content-stretch flex items-center justify-center overflow-clip relative rounded-[8px] shrink-0 size-[40px]" data-name="Primary">
      <Component1 className="overflow-clip relative shrink-0 size-[20px]" variant="4" />
    </div>
  );
}
...
function DivFramerHsn8SvContainer() {
  return (
    <div className="content-stretch flex flex-col items-start opacity-100 relative shrink-0" data-name="div.framer-hsn8sv-container">
      <Primary6 />
    </div>
  );
}
...
function Primary7() {
  return (
    <div className="bg-[rgba(0,0,0,0.1)] content-stretch flex items-center justify-center overflow-clip relative rounded-[8px] shrink-0 size-[40px]" data-name="Primary">
      <Component1 className="overflow-clip relative shrink-0 size-[20px]" variant="5" />
    </div>
  );
}
...
function DivFramer1EmterxContainer() {
  return (
    <div className="content-stretch flex flex-col items-start opacity-100 relative shrink-0" data-name="div.framer-1emterx-container">
      <Primary7 />
    </div>
  );
}
...
function Main1() {
  return (
    <div className="content-stretch flex flex-col h-full items-start justify-between relative shrink-0 w-[640px]" data-name="Main">
      <TitleDescription5 />
      <SocialMediaIcons />
    </div>
  );
...
function MainAlignStretch() {
  return (
    <div className="content-stretch flex items-start justify-center relative self-stretch shrink-0" data-name="Main:align-stretch">
      <Main1 />
    </div>
  );
}
...
function DivPlaceholder2() {
  return (
    <div className="absolute bottom-[108.8px] content-stretch flex flex-col items-start left-[12px] pr-[268.6px] top-[12px]" data-name="div#placeholder">
...
function DivFramer1Qx92KContainer() {
  return (
    <div className="content-stretch flex flex-col h-[44px] items-start justify-center min-w-[468px] relative shrink-0" data-name="div.framer-1qx92k-container">
      <Div3 />
    </div>
  );
}
...
function FormFramer1Rwmlp() {
  return (
    <div className="bg-[#111] flex-[1_0_0] max-w-[500px] min-w-px relative rounded-[16px]" data-name="form.framer-1rwmlp9">
      <div className="max-w-[inherit] overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[20px] items-start max-w-[inherit] p-[16px] relative size-full">
          <LabelFramer1Oda83C />
          <LabelFramer1Wqhl3A />
          <LabelFramer4B0Gvu />
...
function Container7() {
  return (
    <div className="content-stretch flex gap-[40px] items-start justify-center max-w-[1180px] relative shrink-0 w-[1180px]" data-name="Container">
      <MainAlignStretch />
      <FormFramer1Rwmlp />
    </div>
  );
...
function ContactSection() {
  return (
    <div className="content-stretch flex items-center justify-center py-[120px] relative shrink-0 w-full" data-name="Contact Section">
      <Container7 />
    </div>
  );
}
...
function Main() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center justify-center min-w-[1440px] relative shrink-0" data-name="Main">
      <HeroBioSections />
      <QuoteSection />
      <ServicesSection />
      <ProjectsSection />
...
function Span72() {
  return (
    <div className="absolute blur-[0px] content-stretch flex items-start left-0 top-0" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[68px] tracking-[-1.36px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[68px]">Scaling</p>
      </div>
    </div>
  );
}
...
function Span73() {
  return (
    <div className="absolute blur-[0.007px] content-stretch flex items-start left-0 opacity-100 top-[68.01px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[68px] tracking-[-1.36px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[68px]">Start-ups</p>
      </div>
    </div>
  );
}
...
function Span74() {
  return (
    <div className="absolute blur-[0.009px] content-stretch flex items-start left-0 opacity-100 top-[136.02px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[68px] tracking-[-1.36px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[68px]">for</p>
      </div>
    </div>
  );
}
...
function Span75() {
  return (
    <div className="absolute blur-[0.011px] content-stretch flex items-start left-[93.99px] opacity-100 top-[136.02px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[68px] tracking-[-1.36px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[68px]">Growth.</p>
      </div>
    </div>
  );
}

function H2FramerText7() {
  return (
    <div className="h-[204px] relative shrink-0 w-full" data-name="h2.framer-text">
      <Span72 />
      <Span73 />
      <Span74 />
      <Span75 />
...
function DivFramer1Umwttr() {
  return (
    <div className="content-stretch flex flex-col items-start max-w-[340px] relative shrink-0 w-[340px]" data-name="div.framer-1umwttr">
      <H2FramerText7 />
    </div>
  );
}
...
function Span76() {
  return (
    <div className="blur-[0px] content-stretch flex items-start relative shrink-0" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[26px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[31.2px]">/Quick</p>
      </div>
    </div>
  );
}
...
function Span77() {
  return (
    <div className="blur-[0.005px] content-stretch flex items-start opacity-100 relative shrink-0" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[26px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[31.2px]">links</p>
      </div>
    </div>
  );
}
...
function H4FramerText() {
  return (
    <div className="content-stretch flex gap-[5.34px] items-start relative shrink-0 w-full" data-name="h4.framer-text">
      <Span76 />
      <Span77 />
    </div>
  );
...
function Primary8() {
  return (
    <button className="absolute bg-[#faf7f3] content-stretch cursor-pointer flex items-center justify-center left-0 opacity-100 rounded-[8px] top-[0.02px]" data-name="Primary">
...
function Primary9() {
  return (
    <button className="absolute bg-[#faf7f3] content-stretch cursor-pointer flex items-center justify-center left-[84.44px] opacity-100 rounded-[8px] top-[0.03px]" data-name="Primary">
...
function Primary10() {
  return (
    <button className="absolute bg-[#faf7f3] content-stretch cursor-pointer flex items-center justify-center left-[193.34px] opacity-100 rounded-[8px] top-[0.04px]" data-name="Primary">
...
function Primary11() {
  return (
    <div className="absolute bg-[#faf7f3] content-stretch flex items-center justify-center left-0 opacity-99 rounded-[8px] top-[45.27px]" data-name="Primary">
...
function Primary12() {
  return (
    <button className="absolute bg-[#faf7f3] content-stretch cursor-pointer flex items-center justify-center left-[87.15px] opacity-99 rounded-[8px] top-[45.31px]" data-name="Primary">
...
function QuickLinks() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[20px] items-start justify-center max-w-[300px] min-w-px relative" data-name="Quick Links">
      <DivFramer113Ci7D />
      <Links />
    </div>
  );
...
function Span110() {
  return (
    <div className="blur-[0px] content-stretch flex items-start relative shrink-0" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[26px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[31.2px]">/Contact</p>
      </div>
    </div>
  );
}
...
function PFramerText44() {
  return (
    <div className="content-stretch flex flex-col items-start opacity-100 relative shrink-0 w-full" data-name="p.framer-text">
...
function Contact() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[18.41px] items-start justify-center max-w-[300px] min-w-px relative" data-name="Contact">
      <DivFramer5Sim8L />
      <Links1 />
    </div>
  );
...
function Columns() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-start justify-between max-w-[720px] min-w-px relative" data-name="Columns">
      <QuickLinks />
      <Contact />
    </div>
  );
...
function Container8() {
  return (
    <div className="content-stretch flex items-end justify-between max-w-[1180px] relative shrink-0 w-[1180px]" data-name="Container">
      <DivFramer1Umwttr />
      <Columns />
    </div>
  );
...
function PFramerText45() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="p.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[417px] text-[rgba(250,247,243,0.1)] text-center tracking-[-8.339px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[375.26px]">MAJD</p>
      </div>
    </div>
  );
}
...
function ForeignobjectFramerFitText() {
  return (
    <div className="absolute bottom-0 content-stretch flex flex-col items-start left-0 max-w-[1200px] opacity-0 overflow-clip top-0 w-[1200px]" data-name="foreignobject.framer-fit-text">
      <PFramerText45 />
    </div>
  );
}
...
function SvgFramer3Vb2N() {
  return (
    <div className="absolute bottom-[-140px] h-[375px] left-[8.33%] max-w-[1200px] opacity-0 overflow-clip right-[8.33%]" data-name="svg.framer-3vb2n7">
      <Component1 className="absolute bottom-0 h-[375px] left-0 right-0" variant="6" />
...
function Desktop4() {
  return (
    <div className="bg-[#111] content-stretch flex items-center justify-center overflow-clip pb-[300px] pt-[120px] relative shrink-0 w-full" data-name="Desktop">
      <Container8 />
      <SvgFramer3Vb2N />
    </div>
  );
...
function DivFramerBcxrl8Container() {
  return (
    <div className="absolute content-stretch flex flex-col inset-[0_0_0.04%_0] items-start justify-center" data-name="div.framer-bcxrl8-container">
      <div className="flex-[1_0_0] min-h-px opacity-4 relative w-full" data-name="div" />
    </div>
  );
}
...
function EndOfBodyStart() {
  return (
    <div className="bg-[#faf7f3] content-stretch flex flex-col items-center min-h-[900px] relative shrink-0 w-full" data-name="End of bodyStart">
      <Main />
      <Desktop4 />
...
function NavigationBarContainerLogoHamburger() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[288px]" data-name="Navigation Bar → Container → Logo & Hamburger">
      <DivFramer19J77Ah />
...
function Closed() {
  return (
    <div className="bg-[#111] content-stretch flex flex-col items-center justify-center py-[12px] relative rounded-[20px] shrink-0 w-[320px]" data-name="Closed">
...
function DivFramer14Q8XytContainer() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[560px] top-[30px] w-[320px]" data-name="div.framer-14q8xyt-container">
      <Closed />
    </div>
  );
}
...
export default function Body() {
  return (
    <div className="bg-[#faf7f3] content-stretch flex flex-col items-start pb-[140px] relative size-full" data-name="body">
      <EndOfBodyStart />
