  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="p.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[color:var(--reveal-color,#111)] text-[22px] tracking-[-0.88px] w-full" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[30.8px] text-balance">I'm Surendhar, a software developer focused on AI, cloud computing, and modern web technologies.</p>
      </div>
    </div>
  );
}
...
function HeroBioSections() {
  return (
    <div id="about" className="content-stretch flex flex-col h-[1800px] items-center justify-center relative shrink-0 w-full" data-name="Hero & Bio Sections">
      <StickyAvatarWrap />
      <Content />
    </div>
  );
...
function ServicesSection() {
  return (
    <div id="services" className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Services Section">
      <Container3 />
    </div>
  );
}
...
function H3FramerText4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h3.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[32px] tracking-[-0.64px] w-full " style={{ fontVariationSettings: '"wdth" 100' }}>
...
function H3FramerText5() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h3.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-white text-[32px] tracking-[-0.64px] w-full " style={{ fontVariationSettings: '"wdth" 100' }}>
...
function Container4() {
  return (
    <ScrollReveal className="content-stretch flex flex-col items-start justify-center max-w-[1180px] relative shrink-0 w-[1180px]" data-name="Container">
...
function ProjectsSection() {
  return (
    <div id="projects" className="content-stretch flex items-center justify-center pt-[180px] relative shrink-0 w-full" data-name="Curated Projects Section">
      <Container4 />
    </div>
  );
}
