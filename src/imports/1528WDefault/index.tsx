...
function H1FramerText() {
  return (
    <div className="[word-break:break-word] font-['Archivo:ExtraBold',sans-serif] font-extrabold h-[313.2px] leading-[0] relative shrink-0 text-[color:var(--reveal-color,#111)] text-[174px] text-center tracking-[-3.48px] w-full" data-name="h1.framer-text">
...
function H2FramerText1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h2.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[color:var(--reveal-color,#111)] text-[76px] tracking-[-1.52px] w-full" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function H2FramerText3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h2.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[color:var(--reveal-color,#111)] text-[76px] tracking-[-1.52px] w-full whitespace-pre-wrap" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function H3FramerText4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h3.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[color:var(--reveal-color,#111)] text-[32px] tracking-[-0.64px] w-full" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function PFramerText40() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="p.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[color:var(--reveal-color,#111)] text-[18px] tracking-[-0.72px] w-full" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function TechnologiesSection() {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center pt-[120px] pb-[80px] px-[20px] gap-12" data-name="Technologies Section">
      <div className="text-center w-full">
        <h2 className="text-[46px] lg:text-[76px] font-semibold text-[color:var(--reveal-color,#111)] tracking-[-1.52px] font-['Archivo:SemiBold',sans-serif]">Technologies, tools with...</h2>
      </div>
      <div className="w-full max-w-[1280px] mt-[20px] mb-[40px]">
      ...
      <div className="flex flex-col items-center w-full pt-16 gap-12">
        <div className="text-center w-full">
          <h2 className="text-[38px] lg:text-[56px] font-semibold text-[color:var(--reveal-color,#111)] tracking-[-1.12px] font-['Archivo:SemiBold',sans-serif]">US Tools and Technologies</h2>
        </div>
