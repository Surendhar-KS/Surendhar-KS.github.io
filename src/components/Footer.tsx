...
const MagneticLink = ({ children, href }: { children: React.ReactNode, href: string }) => {
  ...
  return (
    <motion.a
      ...
      className="relative text-white/70 hover:text-white font-['Archivo',sans-serif] text-sm md:text-base uppercase tracking-[0.2em] transition-colors duration-300 py-4 px-2 group"
    >
      {children}
      ...
      >
        <div className="flex flex-col xl:flex-row justify-between items-start xl:items-end w-full mb-16 md:mb-32 gap-16 xl:gap-12">
          ...
          <div className="flex flex-col">
            <h2 className="font-sans font-bold text-[12vw] xl:text-[9vw] leading-[0.85] tracking-[-0.04em] text-white">
              SCALING
            </h2>
            <div className="flex items-center gap-4 sm:gap-8">
              <div className="hidden sm:block h-[2px] bg-white/10 flex-1 max-w-[80px] lg:max-w-[120px]" />
              <h2 className="font-sans font-bold text-[12vw] xl:text-[9vw] leading-[0.85] tracking-[-0.04em] text-transparent bg-clip-text bg-gradient-to-r from-gray-300 via-gray-500 to-gray-700 italic pr-4">
                SOFTWARE
              </h2>
            </div>
            <h2 className="font-sans font-bold text-[12vw] xl:text-[9vw] leading-[0.85] tracking-[-0.04em] text-white">
          ...
          <div className="flex flex-col items-start xl:items-end gap-6 xl:pb-4">
            <p className="text-white/70 font-['Archivo',sans-serif] text-sm md:text-base uppercase tracking-[0.2em] font-medium">
              Start a conversation
            </p>
            <motion.a 
              href="mailto:ksurendhar725@gmail.com"
              aria-label="Send email to ksurendhar725@gmail.com"
              className="group flex flex-col items-start xl:items-end relative"
              whileHover="hover"
            >
              <span className="font-sans text-xl sm:text-2xl md:text-3xl lg:text-4xl text-white font-medium transition-colors group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-white/40 break-all sm:break-normal">
        ...
        <div className="w-full flex flex-col lg:flex-row justify-between items-center pt-8 border-t border-white/10 gap-8 lg:gap-0">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12">
            <div className="flex gap-6">
              <a href="https://linkedin.com/in/surendhar-ks/" target="_blank" rel="noreferrer" aria-label="LinkedIn Profile Footer" className="text-white/70 hover:text-white transition-colors">
                <span className="sr-only">LinkedIn</span>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
              </a>
              <a href="https://github.com/surendhar-ks" target="_blank" rel="noreferrer" aria-label="GitHub Profile Footer" className="text-white/70 hover:text-white transition-colors">
                <span className="sr-only">GitHub</span>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
              </a>
            </div>
            <div className="text-white/60 font-['Archivo',sans-serif] text-xs md:text-sm tracking-wider uppercase">
