        ...
        <div className="w-full flex flex-col lg:flex-row justify-between items-center pt-8 border-t border-white/10 gap-8 lg:gap-0">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12">
            <div className="flex gap-6">
              <a href="https://linkedin.com/in/surendhar-ks/" target="_blank" rel="noreferrer" aria-label="LinkedIn Profile" className="text-white/40 hover:text-white transition-colors">
                <span className="sr-only">LinkedIn</span>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
              </a>
              <a href="https://github.com/surendhar-ks" target="_blank" rel="noreferrer" aria-label="GitHub Profile" className="text-white/40 hover:text-white transition-colors">
