    ...
    <div id="contact" className="w-full flex justify-center pt-24 md:pt-32 pb-24 md:pb-32 px-6 relative overflow-hidden" data-name="Contact Section">
      <div className="w-full max-w-[1180px] grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8 items-center">
        ...
        <div className="flex flex-col items-start gap-8 z-10">
          ...
          >
            <h2 className="font-sans font-extrabold text-[48px] sm:text-[68px] md:text-[88px] tracking-[-0.04em] text-[#111] leading-[0.9] mb-6">
              Let's <br/>
          ...
          >
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <MagneticSocial href="https://www.linkedin.com/in/surendhar-ks/" ariaLabel="LinkedIn Profile Contact">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
              </MagneticSocial>
            </motion.div>
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <MagneticSocial href="https://github.com/surendhar-ks" ariaLabel="GitHub Profile Contact">
