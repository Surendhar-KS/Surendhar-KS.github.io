        ...
        >
          <div className="relative flex flex-col items-center px-2 sm:px-4">
            ...
            <motion.div 
              ...
              className="absolute left-2 md:-left-[115px] -top-12 md:-top-[60px] w-[50px] md:w-[110px] z-10"
            >
            ...
            <motion.div 
              ...
              className="absolute right-2 md:-right-[115px] -bottom-8 md:-bottom-[50px] w-[45px] md:w-[100px] z-[50] drop-shadow-2xl"
            >
