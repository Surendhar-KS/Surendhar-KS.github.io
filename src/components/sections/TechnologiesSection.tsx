...
export default function TechnologiesSection() {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center pt-[180px] pb-[40px] px-[20px] gap-[96px] relative overflow-hidden" data-name="Technologies Section" data-theme="dark">
