...
import imgVnxqLcPHw9VbVzy6BDpZ8PUsaUPng from "./871635233f2d72d2db7411af70f8a7ef031eec22.png";
import imgWgEhvRrQs62RgxlzrnXjj8Rr4Png from "./42ae84b77baf71c15fc848c4a6c1426a8fe9436d.png";
import imgI3AzeVtkvdKbGl9Tx38TUdXEb0Png from "./f255bb720a6762bf23fb4ce7e24059abfb6153f6.png";
import img1C3ZqErGdc7PqPIbDxtBaD4VGiQPng from "./9a9330cba32e3aa7515a97a36072c8c835cc56a7.png";
...
import imgIc9K42RYytbJtnRujXdcNxChScPng from "./886bea6a9c23b041bf6cb5e7c4b4aa5109407b27.png";
import imgDiv from "./ad1e8761706b3265f8711a577d750ebe9be9f81d.png";
type Component1Props = {
  className?: string;
  variant?: "1" | "7" | "8" | "18" | "19" | "20" | "21" | "22";
};

function Component1({ className, variant = "1" }: Component1Props) {
  const is18Or19Or20Or21 = ["18", "19", "20", "21"].includes(variant);
  ...
  const is8 = variant === "8";
  return (
    <div className={className || `overflow-clip relative ${variant === "22" ? "h-[375px] w-[1200px]" : is18Or19Or20Or21 ? "size-[20px]" : is7Or8 ? "size-[16px]" : "size-[64px]"}`}>
      {["1", "18", "19", "20", "21"].includes(variant) && (
        <svg className="absolute block inset-0 size-full" fill="none" height={is18Or19Or20Or21 ? "20" : "64"} preserveAspectRatio="none" viewBox={is18Or19Or20Or21 ? "0 0 20 20" : "0 0 64 64"} width={is18Or19Or20Or21 ? "20" : "64"}>
          {is18Or19Or20Or21 && (
            <g clipPath={is20 ? "url(#clip0_0_38)" : is19 ? "url(#clip0_0_36)" : undefined} id={is21 ? "832930135" : is20 ? "3343558269" : is19 ? "2660449837" : "1554250168"}>
              <path d={is21 ? svgPaths.p193f5480 : is20 ? svgPaths.pc8bab00 : is19 ? svgPaths.pdedca80 : svgPaths.p9d0b1f0} id={is21 ? "gjBIq5II1" : is20 ? "zjjX2FG5P" : is19 ? "SX1RGYN3B" : "I7SuWiIoi"} stroke="#111111" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
              {["20", "21"].includes(variant) && <path d={is21 ? svgPaths.p205b7af0 : svgPaths.p3575d1f0} id={is21 ? "H7TM4gAQc" : "c0NPcsxWN"} stroke="#111111" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />}
              {is20 && <path d={svgPaths.pd7c4380} id="rJBOynbA9" stroke="#111111" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />}
            </g>
          )}
          {["19", "20"].includes(variant) && (
            <defs>
              <clipPath id={is20 ? "clip0_0_38" : "clip0_0_36"}>
...
type ComponentProps = {
  className?: string;
  variant?: "13" | "14" | "15" | "16" | "17" | "18";
};

function Component({ className, variant = "13" }: ComponentProps) {
  return (
    <div className={className || "overflow-clip relative size-[28.284px]"}>
      <svg className="absolute block inset-0 size-full" fill="none" height="20" preserveAspectRatio="none" viewBox="0 0 20 20" width="20">
        <g id="1235104226">
          <path d={svgPaths.p370e6b00} id="JgTGlz8TK" stroke={["14", "16", "17"].includes(variant) ? "#FAF7F3" : "#111111"} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function AvatarWrap() {
  return (
    <div className="h-[456px] relative shrink-0 w-[400px]" data-name="Avatar Wrap">
      <AvatarBack />
      <AvatarFront />
    </div>
  );
...
function StickyContainer() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-[685.6px] items-end justify-center min-w-px overflow-clip pb-[20px] sticky top-0" data-name="Sticky Container">
      <AvatarWrap />
    </div>
  );
}
...
function StickyAvatarWrap() {
  return (
    <div className="content-stretch flex h-[1371.2px] items-start justify-center relative shrink-0 w-full" data-name="Sticky Avatar Wrap">
      <StickyContainer />
    </div>
  );
}
...
function H1FramerText() {
  return (
    <div className="[word-break:break-word] font-['Archivo:ExtraBold',sans-serif] font-extrabold h-[313.2px] leading-[0] relative shrink-0 text-[#111] text-[174px] text-center tracking-[-3.48px] w-full" data-name="h1.framer-text">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col justify-center left-[calc(50%+1.6px)] top-[77.6px] w-[1011.538px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[156.6px]">{`SOFTWARE `}</p>
      </div>
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col justify-center left-[calc(50%+2.35px)] top-[234.9px] w-[945.179px]" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function HoloTriangleRounded() {
  return (
    <div className="absolute bottom-[-98.95px] flex h-[197.902px] items-center justify-center right-[-34.95px] w-[197.903px]">
...
function H2FramerText() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h2.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#111] text-[68px] tracking-[-1.36px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function PFramerText() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 right-0 top-[-1px]" data-name="p.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#111] text-[18px] tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function Text() {
  return (
    <div className="absolute bottom-[20px] content-stretch flex items-end justify-between left-0 right-0" data-name="Text">
      <DivFramerLdffyv />
      <DivFramerJb5Itc />
    </div>
  );
...
function HeroSection() {
  return (
    <div className="content-stretch flex h-[685.6px] items-center justify-center relative shrink-0 w-full" data-name="Hero Section">
      <Container />
    </div>
  );
}
...
function H2FramerText1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h2.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#111] text-[76px] tracking-[-1.52px] w-full" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function PFramerText1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="p.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#111] text-[22px] tracking-[-0.88px] w-full whitespace-pre-wrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[30.8px] mb-0">{`I’m Majd, a builder based in `}</p>
        <p className="leading-[30.8px] mb-0">{`Syria, currently working on `}</p>
        <p className="leading-[30.8px] mb-0">Templyo, a platform for high-</p>
        <p className="leading-[30.8px]">quality Framer templates.</p>
      </div>
    </div>
  );
}
...
function PFramerText2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="p.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#111] text-[18px] tracking-[-0.72px] w-full whitespace-pre-wrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px] mb-0">{`I’m a software engineer and Framer creator with a `}</p>
        <p className="leading-[25.2px] mb-0">{`strong focus on building modern, scalable, and `}</p>
        <p className="leading-[25.2px]">{`conversion-driven web experiences. `}</p>
      </div>
    </div>
  );
}
...
function PFramerText3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="p.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#111] text-[18px] tracking-[-0.72px] w-full whitespace-pre-wrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px] mb-0">{`Over the years, I’ve created and shipped multiple `}</p>
        <p className="leading-[25.2px] mb-0">{`SaaS products and Framer templates used by `}</p>
        <p className="leading-[25.2px]">global customers, helping them launch faster.</p>
      </div>
    </div>
  );
}
...
function ArrowButton() {
  return (
    <div className="overflow-clip relative rounded-[8px] shrink-0 size-[28px]" data-name="Arrow Button">
      ...
      <Component className="absolute bottom-[-21.14px] flex items-center justify-center left-[-21.14px] size-[28.284px]" variant="14" />
    </div>
  );
}
...
function Container1() {
  return (
    <div className="content-stretch flex h-[479.2px] items-end justify-between max-w-[1180px] pb-[20px] relative shrink-0 w-[1180px]" data-name="Container">
...
function BioSection() {
  return (
    <div className="content-stretch flex h-[685.6px] items-end justify-center relative shrink-0 w-full" data-name="Bio Section">
      <Container1 />
    </div>
  );
}
...
function HeroBioSections() {
  return (
    <div className="content-stretch flex flex-col h-[1371.2px] items-center justify-center relative shrink-0 w-full" data-name="Hero & Bio Sections">
      <StickyAvatarWrap />
      <Content />
    </div>
  );
...
function Span() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[5.45px] top-[-0.4px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">From</p>
      </div>
    </div>
  );
}
...
function Span1() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[97.61px] top-[-0.4px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">idea</p>
      </div>
    </div>
  );
}
...
function Span2() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[172.9px] top-[-0.4px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">to</p>
      </div>
    </div>
  );
}
...
function Span3() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[212.44px] top-[-0.4px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">launch.</p>
      </div>
    </div>
  );
}
...
function Span4() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[336.14px] top-[-0.4px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">Clean,</p>
      </div>
    </div>
  );
}
...
function Span5() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[446.24px] top-[-0.4px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">scalable</p>
      </div>
    </div>
  );
}
...
function Span6() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[585.02px] top-[-0.4px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">digital</p>
      </div>
    </div>
  );
}
...
function Span7() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[686.95px] top-[-0.4px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">products</p>
      </div>
    </div>
  );
}
...
function Span8() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[59.98px] top-[42.8px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">built</p>
      </div>
    </div>
  );
}
...
function Span9() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[134.94px] top-[42.8px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">to</p>
      </div>
    </div>
...
function Span10() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[174.48px] top-[42.8px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">move</p>
      </div>
    </div>
  );
}
...
function Span11() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[270.93px] top-[42.8px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">fast,</p>
      </div>
    </div>
  );
}
...
function Span12() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[346.71px] top-[42.8px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">stay</p>
      </div>
    </div>
  );
}
...
function Span13() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[421.06px] top-[42.8px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">simple,</p>
      </div>
    </div>
  );
}
...
function Span14() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[543.15px] top-[42.8px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">and</p>
      </div>
    </div>
  );
}
...
function Span15() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[611.26px] top-[42.8px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">perform</p>
      </div>
    </div>
  );
}
...
function Span16() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[743.25px] top-[42.8px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">in</p>
      </div>
    </div>
  );
}
...
function Span17() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[10.76px] top-[86px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">real-world</p>
      </div>
    </div>
  );
}
...
function Span18() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[174.39px] top-[86px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">use,</p>
      </div>
    </div>
  );
}
...
function Span19() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[250.29px] top-[86px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">driven</p>
      </div>
    </div>
  );
}
...
function Span20() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[355.91px] top-[86px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">by</p>
      </div>
    </div>
  );
}
...
function Span21() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[402.86px] top-[86px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">clarity,</p>
      </div>
    </div>
  );
}
...
function Span22() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[510.26px] top-[86px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">structured</p>
      </div>
    </div>
  );
}
...
function Span23() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[678.56px] top-[86px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">systems,</p>
      </div>
    </div>
  );
}
...
function Span24() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[238.35px] top-[129.2px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">and</p>
      </div>
    </div>
...
function Span25() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[306.46px] top-[129.2px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">intentional</p>
      </div>
    </div>
  );
}
...
function Span26() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-[477.83px] top-[129.2px]" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[36px] text-center tracking-[-0.72px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[43.2px]">design.</p>
      </div>
    </div>
  );
}
...
function Div() {
  return (
    <div className="h-[172.8px] relative shrink-0 w-full" data-name="div">
      <Span />
      <Span1 />
      <Span2 />
      <Span3 />
...
function Content1() {
  return (
    <div className="content-stretch flex h-[685.6px] items-center justify-center overflow-clip shrink-0 sticky top-0 w-full" data-name="Content">
...
function Container2() {
  return (
    <div className="content-stretch flex flex-col h-[1028.4px] items-center max-w-[1180px] relative shrink-0 w-[1180px]" data-name="Container">
      <Content1 />
    </div>
  );
}
...
function H3FramerText() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h3.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[32px] tracking-[-0.64px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function ServicesCards() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center justify-center relative shrink-0 w-full" data-name="Services Cards">
      <DivFramer99NfdqContainer />
      <DivFramer5X1N75Container />
      <DivFramer945PruContainer />
      <DivFramerMg5C04Container />
    </div>
  );
}
...
function Container3() {
  return (
    <div className="content-stretch flex flex-col gap-[60px] items-start justify-center max-w-[1180px] relative shrink-0 w-[1180px]" data-name="Container">
      <DivFramer1Nuet6A />
      <ServicesCards />
    </div>
  );
...
function H2FramerText3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h2.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#111] text-[76px] tracking-[-1.52px] w-full whitespace-pre-wrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[76px] mb-0">{`Featured `}</p>
...
function ArrowButton1() {
  return (
    <div className="overflow-clip relative rounded-[8px] shrink-0 size-[28px]" data-name="Arrow Button">
      <div className="absolute border border-[#111] border-solid inset-0 rounded-[8px]" data-name="::after" />
      <Component className="-translate-x-1/2 absolute bottom-[-0.51%] flex items-center justify-center left-1/2 top-[-0.51%] w-[28.284px]" variant="15" />
      <Component className="absolute bottom-[-21.14px] flex items-center justify-center left-[-21.14px] size-[28.284px]" variant="16" />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h3.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[32px] tracking-[-0.64px] w-full" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[38.4px]">Damas</p>
      </div>
    </div>
  );
}
...
function PFramerText18() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="p.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#111] text-[16px] tracking-[-0.64px] w-full" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[22.4px]">Agency Framer Template</p>
      </div>
    </div>
  );
}
...
function DivFramer19XgbboContainer() {
  return (
    <div className="absolute content-stretch flex flex-col inset-[0_598px_486.97px_0] items-start" data-name="div.framer-19xgbbo-container">
      <ProjectCard />
    </div>
  );
}
...
function H3FramerText5() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h3.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[32px] tracking-[-0.64px] w-full" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[38.4px]">Najm</p>
      </div>
    </div>
  );
}
...
function PFramerText19() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="p.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#111] text-[16px] tracking-[-0.64px] w-full" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[22.4px]">SaaS Framer Template</p>
      </div>
    </div>
  );
}
...
function DivFramer19XgbboContainer1() {
  return (
    <div className="absolute content-stretch flex flex-col inset-[0_0_486.97px_598px] items-start" data-name="div.framer-19xgbbo-container">
      <ProjectCard1 />
    </div>
  );
}
...
function H3FramerText6() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h3.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[32px] tracking-[-0.64px] w-full" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[38.4px]">Kavi</p>
      </div>
    </div>
  );
}
...
function PFramerText20() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="p.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#111] text-[16px] tracking-[-0.64px] w-full" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[22.4px]">AI Framer Template</p>
      </div>
    </div>
  );
}
...
function H3FramerText7() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h3.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[32px] tracking-[-0.64px] w-full" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[38.4px]">PostWing</p>
      </div>
    </div>
  );
}
...
function PFramerText21() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="p.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#111] text-[16px] tracking-[-0.64px] w-full" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[22.4px]">Social Media Scheduler</p>
      </div>
    </div>
  );
}
...
function ProjectsSection() {
  return (
    <div className="content-stretch flex items-center justify-center pt-[120px] relative shrink-0 w-full" data-name="Projects Section">
      <Container4 />
    </div>
  );
}
...
function DivFramer45Mpb() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="div.framer-45mpb9">
      <H2FramerText5 />
    </div>
  );
}
...
function Ic9K42RYytbJtnRujXdcNxChScPng() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="ic9k42rYytbJtnRUJXdcNxCHSc.png">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-full left-[-57.15%] max-w-none top-0 w-[214.3%]" src={imgIc9K42RYytbJtnRujXdcNxChScPng} />
      </div>
    </div>
  );
}
...
function PFramerText38() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="p.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[44px] tracking-[-0.88px] w-full whitespace-pre-wrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[52.8px] mb-0">{`See how we `}</p>
        <p className="leading-[52.8px] mb-0">{`shape brands `}</p>
        <p className="leading-[52.8px] mb-0">{`with clarity and `}</p>
        <p className="leading-[52.8px] mb-0">{`craft— explore `}</p>
        <p className="leading-[52.8px]">our blog</p>
      </div>
    </div>
  );
}
...
function ArrowButton2() {
  return (
    <div className="overflow-clip relative rounded-[8px] shrink-0 size-[28px]" data-name="Arrow Button">
      ...
      <Component className="-translate-x-1/2 absolute bottom-[-0.51%] flex items-center justify-center left-[calc(50%-0.01px)] top-[-0.51%] w-[28.284px]" variant="17" />
      <Component className="absolute bottom-[-21.14px] flex items-center justify-center left-[-21.15px] size-[28.284px]" variant="18" />
    </div>
  );
}
...
function DivFramer1Leqxa() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="div.framer-1leqxa3">
      <DivFramer1GwykhoContainer />
      <DivFramer1GwykhoContainer1 />
      <AllPostsCard />
    </div>
  );
}
...
function H2FramerText6() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h2.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#111] text-[76px] tracking-[-1.52px] w-full" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[76px]">Let’s talk.</p>
      </div>
    </div>
  );
}
...
function PFramerText40() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="p.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#111] text-[18px] tracking-[-0.72px] w-full" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[25.2px]">{`Have a project or need help? Fill out the form, and we'll get back to you soon.`}</p>
      </div>
    </div>
  );
}
...
function TitleDescription5() {
  return (
    <div className="content-stretch flex flex-col gap-[9px] items-center justify-center relative shrink-0 w-full" data-name="Title & Description">
      <DivFramer15Yiv3X />
      <DivFramerJf7A8U />
    </div>
  );
...
function Primary4() {
  return (
    <div className="bg-[rgba(0,0,0,0.1)] content-stretch flex items-center justify-center overflow-clip relative rounded-[8px] shrink-0 size-[40px]" data-name="Primary">
      <Component1 className="overflow-clip relative shrink-0 size-[20px]" variant="18" />
    </div>
  );
}
...
function Primary5() {
  return (
    <div className="bg-[rgba(0,0,0,0.1)] content-stretch flex items-center justify-center overflow-clip relative rounded-[8px] shrink-0 size-[40px]" data-name="Primary">
      <Component1 className="overflow-clip relative shrink-0 size-[20px]" variant="19" />
    </div>
  );
}
...
function Primary6() {
  return (
    <div className="bg-[rgba(0,0,0,0.1)] content-stretch flex items-center justify-center overflow-clip relative rounded-[8px] shrink-0 size-[40px]" data-name="Primary">
      <Component1 className="overflow-clip relative shrink-0 size-[20px]" variant="20" />
    </div>
  );
}
...
function Primary7() {
  return (
    <div className="bg-[rgba(0,0,0,0.1)] content-stretch flex items-center justify-center overflow-clip relative rounded-[8px] shrink-0 size-[40px]" data-name="Primary">
      <Component1 className="overflow-clip relative shrink-0 size-[20px]" variant="21" />
    </div>
  );
}
...
function Main1() {
  return (
    <div className="h-full relative shrink-0 w-[640px]" data-name="Main">
...
function Span27() {
  return (
    <div className="content-stretch flex flex-col items-center relative self-stretch shrink-0" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[16px] text-center text-shadow-[0px_19.2px_0px_#111] tracking-[-0.32px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function Main() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center justify-center min-w-[1512.800048828125px] relative shrink-0" data-name="Main">
      <HeroBioSections />
      <QuoteSection />
      <ServicesSection />
      <ProjectsSection />
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h2.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[68px] tracking-[-1.36px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[68px] mb-0 whitespace-pre">{`Scaling `}</p>
        <p className="leading-[68px] mb-0 whitespace-pre">{`Start-ups `}</p>
        <p className="leading-[68px] whitespace-pre">for Growth.</p>
      </div>
    </div>
  );
}
...
function DivFramer1Umwttr() {
  return (
    <div className="content-stretch flex flex-col items-start max-w-[340px] relative shrink-0" data-name="div.framer-1umwttr">
      <H2FramerText7 />
    </div>
  );
}
...
function H4FramerText() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h4.framer-text">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[26px] w-full" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[31.2px]">/Quick links</p>
      </div>
    </div>
  );
}
...
function Span33() {
  return (
    <div className="content-stretch flex flex-col items-start relative self-stretch shrink-0" data-name="span">
      <div className="[word-break:break-word] cursor-pointer flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[16px] text-left text-shadow-[0px_19.2px_0px_#111] tracking-[-0.32px] whitespace-nowrap" role="button" style={{ fontVariationSettings: '"wdth" 100' }} tabIndex="0">
...
function Primary10() {
  return (
    <button className="absolute bg-[#faf7f3] content-stretch cursor-pointer flex items-center justify-center left-[193.34px] rounded-[8px] top-0" data-name="Primary">
...
function Span53() {
  return (
    <div className="content-stretch flex flex-col items-start relative self-stretch shrink-0" data-name="span">
      <div className="[word-break:break-word] flex flex-col font-['Archivo:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111] text-[16px] text-shadow-[0px_19.2px_0px_#111] tracking-[-0.32px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function Contact() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[18.4px] items-start justify-center max-w-[300px] min-w-px relative" data-name="Contact">
      <DivFramer5Sim8L />
      <Links1 />
    </div>
  );
...
function SvgFramer3Vb2N() {
  return (
    <div className="absolute bottom-[-140px] h-[375px] left-[10.34%] max-w-[1200px] opacity-0 overflow-clip right-[10.35%]" data-name="svg.framer-3vb2n7">
      <Component1 className="absolute bottom-0 h-[375px] left-0 right-0" variant="22" />
...
function DivFramerBcxrl8Container() {
  return (
    <div className="absolute content-stretch flex flex-col inset-[0_0_0.05%_0] items-start justify-center" data-name="div.framer-bcxrl8-container">
...
function EndOfBodyStart() {
  return (
    <div className="bg-[#faf7f3] content-stretch flex flex-col items-center min-h-[685.5999755859375px] relative shrink-0 w-full" data-name="End of bodyStart">
      <Main />
      <Desktop4 />
  ...
  return (
    <div className="content-stretch flex items-start py-[1.3px] relative shrink-0" data-name="a.framer-text">
      <button className="[word-break:break-word] cursor-pointer flex flex-col font-['Archivo:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#faf7f3] text-[22px] text-left tracking-[-0.88px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[30.8px]">Majd</p>
      </button>
    </div>
  );
}
...
function DivFramer14Q8XytContainer() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[596.4px] top-[30px] w-[320px]" data-name="div.framer-14q8xyt-container">
      <Closed />
    </div>
  );
}
...
function Body() {
  return (
    <div className="absolute bg-[#faf7f3] content-stretch flex flex-col h-[7051px] items-start left-[-0.23px] pb-[140px] right-[0.23px] top-[-0.14px]" data-name="body">
      <EndOfBodyStart />
...
export default function Component1528WDefault() {
  return (
    <div className="bg-white relative size-full" data-name="1528w default">
      <Body />
    </div>
  );
}